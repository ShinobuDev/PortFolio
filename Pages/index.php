                    ...
                    <li class="l-section section section--is-active">
                        <div class="intro">
                            <div class="intro--banner">
                                <h1>Bienvenue<br>sur mon<br>portfolio</h1>
                            ...
                            <div class="work--lockup">
                                <ul class="slider">
                                    <li class="slider--item slider--item-left">
                                        <?php require_once(
                                        'yaml\yaml.php');
                                        $data = yaml_parse_file("Compétences/Competences.yaml");
                                        ...
                                        <div class='container'>
                                            <div class='skills'
                                                 style='width:" . $uneCompetence["niveau"] . "%; background-color:" . $uneCompetence["couleur"] . "'>
                                                " . $uneCompetence["niveau"] . "
                                            </div>
                                        </div>
                                        ";
                                            }
...
<form action="Compétences/Competences.php" method="post">
    <button type="submit">Compétences</button>
</form>
<form action="Réalisations/Realisations.php" method="post">
    <button type="submit">Réalisations</button>
</form>
<form action="Formation/Formation.php" method="post">
    <button type="submit">Formation</button>
</form>
<form action="Contact/Contact.php" method="post">
    <button type="submit">Contact</button>
</form>
</body>'.include "Formation/Formation.php".'